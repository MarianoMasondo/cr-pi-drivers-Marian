      ...
      <Link to="/home">
        <button className="back-home">Home</button>
          ...
          <p>
            ...
            developer. I am passionate about learning, creating and solving new
            challenges.
          </p>
          <p>
            My journey in this industry began as a fresh challenge, and I have
            shown that determination and continuous learning can overcome any
            obstacle.
          </p>
          <p>We should have a coffee and talk!</p>
          <p>See you!</p>
          <img src={picture} className="foto-about" alt="My Image" />
