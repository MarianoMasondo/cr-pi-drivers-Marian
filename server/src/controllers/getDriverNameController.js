...
const driverName = async (name) => {     
    ...
    const apiDataDrivers = apiDrivers.map((driver) => ({
        ...
        image: driver.image.url || "https://images.squarespace-cdn.com/content/v1/5041475ac4aa99448132115f/1678818503863-3TYIXGRUMHR7XW0W43U4/IMG_2208.JPG",
    ...
    if (!apiDrivers.length && !dbDrivers.length) throw new Error("This driver does not exist.");
